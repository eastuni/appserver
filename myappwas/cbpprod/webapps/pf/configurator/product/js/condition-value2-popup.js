...
function renderConditionValue2Popup(data, rowIndex, historyButton){
    ...
    if (historyButton){
    	...
    	// OHS 20180503 추가 - 소숫점일치를 위해 추가
      	if(selectedCondition && selectedCondition.conditionDetailTypeCode == '01') {
      	...
      	// 율
      	else if(selectedCondition && (selectedCondition.conditionDetailTypeCode == '05' 
      								|| selectedCondition.conditionDetailTypeCode == '08')) {
