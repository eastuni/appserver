define(
    [
        'text!app/views/page/popup/CAPST/popup-condition-search.html',
...
//
            fn_loadList: function (cndType) {	
                ...
                if(cndType !== "undefined")
                	 sParam.cndTpCd = cndType;
