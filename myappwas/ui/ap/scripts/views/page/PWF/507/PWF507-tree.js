define(
    [
        ...
        , 'text!app/views/page/PWF/507/PWF507-tree-tpl.html'
    ...
    function (config
        ...
        var PWFTreeView = Backbone.View.extend({
            ...
            , initialize: function (initData) {
                ...
                that.subViews['PWF507Tree'] = new bxTree({
...
//                       ]
            ...
            , render: function () {
                ...
                that.$unitTreeRoot.html(this.subViews['PWF507Tree'].render());
                that.loadList();
                ...
                bxProxy.post(sUrl, JSON.stringify(linkData), {
                    ...
                    success: function (responseData) {
                        if (responseData.header.errorMessageProcessed) { //에러
                            ...
                            that.subViews['PWF507Tree'].renderItem(responseData.SrvcMgmtSvcGetInstSrvcTreeOut.tbl);
                        }
                    }
                });
            }
