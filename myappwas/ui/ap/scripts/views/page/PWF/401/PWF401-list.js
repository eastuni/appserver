...
define(
    [
        ...
        , 'text!app/views/page/PWF/401/PWF401-list-tpl.html'
    ...
    function (config
        ...
        var PWF401TabView = Backbone.View.extend({
            ...
            , initialize: function (initData) {
                ...
                bxProxy.all([
                    ...
                    success: function () {
                        /* ------------------------------------------------------------ */
                        that.PWF401SingleGrid = new ExtGrid({
                            /* ------------------------------------------------------------ */
                            // 단일탭 그리드 컬럼 정의
                            fields: ['No', 'aprvlCndNbr', 'srvcCd', 'srvcNm', 'aprvlRsnCd', 'aprvlPtrnDscd', 'wflowId', 'stsCd']
                            , id: 'PWF401SingleGrid'
                            , columns: [
                                {
                                    text: 'No.'
                            ...
                            , listeners: {
                                dblclick: {
                                    ...
                                    fn: function () {
                                         ...
                                         */
                                        var selectedRecord = that.PWF401SingleGrid.grid.getSelectionModel().selected.items[0];
                                        if (!selectedRecord) {
                                            return;
                                        } else {
                                            ...
                                            that.$el.trigger({
                                                ...
                                                pageHandler: 'PWF402',
                                                pageDPName: bxMsg('cbb_items.SCRN#PWF402'),
                                                pageInitialize: true,
                                                pageRenderInfo: {
            ...
            // 첫번째 탭 활성화 설정
            , render: function () {
                this.currentSubTab = 'PWF401-single-tab';
                return this.$el;
            }
            ...
            , createGrid: function (target) {
                if (target == "single") {
                    this.$el.find(".PWF401-single-grid").html(this.PWF401SingleGrid.render({'height': CgridHeight}));
                }
            } // end of createGrid
            ...
            , selSingle: function () {
                ...
                sParam.wflowId = param.wflowId;  // 워크플로우식별자
                    ...
                    success: function (responseData) {
                        if (fn_commonChekResult(responseData)) {
                            ...
                            if (tbList != null || tbList.length > 0) {
                                that.PWF401SingleGrid.setData(tbList);
                            }
                            else {
                                that.PWF401SingleGrid.resetData();
                            }
                        }
                    }   // end of suucess: fucntion
                });     // end of bxProxy
            } // end of 조회
        }); // end of PWF401TabView = Backbone.View.extend


        return PWF401TabView;
