...
define(
    [
         ...
         ,'text!app/views/page/PWF/401/PWF401-base-tpl.html'
   ...
   function (
         ...
         var PWF401BaseView = Backbone.View.extend({
               // 태그이름 설정
               tagName: 'section',
               // 클래스이름 설정
               className: 'PWF401-base-page',
               // 탬플릿 설정
               templates: {
                   'tpl': tpl
               }
               // 이벤트 설정
               , events: {
                   'click .PWF401-select-btn': 'selectPWF401Base'
               ...
               , render: function() {
                   ...
                   sParam = {};
                   selectStyle = {};
                   sParam.className = "PWF401-aprvlRsnCd-wrap";
                   ...
                   sParam = {};
                   selectStyle = {};
                   sParam.className = "PWF401-aprvlPtrnDscd-wrap";
               ...
               // 입출력항목 setting
               /* ======================================================================== */
               , setPWF401BaseData: function(that, responseData, type) {
                   that = this;
                   ...
                   if(type == "X") {  // 초기화                      
                       ...
                       that.$el.find('[data-form-param="wflowId"]').val(responseData.wflowId);       //워크플로우식별자
               ...
               /* ======================================================================== */
                , popUpBrowseWflowId: function() {
                   ...
                   popupWflowId.on('popUpSetData', function(param) {
                       that.$el.find('[data-form-param="wflowId"]').val(param.wflowId); // 프로세스식별자
                       that.$el.find('[data-form-param="wflowId"]').prop("disabled", true);
               ...
               , selectPWF401Base: function () {
                   ...
                   param.wflowId = this.$el.find('[data-form-param="wflowId"]').val(); // 워크플로우식별자
                   this.$el.find('[data-form-param="wflowId"]').prop("disabled", true);
                   param.cmpntCd = this.$el.find('[data-form-param="cmpntCd"]').val(); // 컴포넌트코드
                   param.srvcCd = this.$el.find('[data-form-param="srvcCd"]').val(); // 서비스코드
                   param.aprvlCndDstnctnCd = "02";
