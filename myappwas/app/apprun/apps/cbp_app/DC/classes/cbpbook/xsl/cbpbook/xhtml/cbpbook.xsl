...
<xsl:output method="xml" encoding="euc-kr" indent="no" doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"/>
...
<xsl:include href="../../docbook/VERSION.xsl"/>
<xsl:include href="param.xsl"/>
<xsl:include href="../../docbook/lib/lib.xsl"/>
<xsl:include href="../common/l10n.xsl"/>
<xsl:include href="../../docbook/common/common.xsl"/>
<xsl:include href="../../docbook/common/utility.xsl"/>
<xsl:include href="../common/labels.xsl"/>
<xsl:include href="../../docbook/common/titles.xsl"/>
<xsl:include href="../../docbook/common/subtitles.xsl"/>
<xsl:include href="../common/gentext.xsl"/>
<xsl:include href="../../docbook/common/targets.xsl"/>
<xsl:include href="../../docbook/common/olink.xsl"/>
<xsl:include href="../../docbook/common/pi.xsl"/>
<xsl:include href="../../docbook/xhtml/autotoc.xsl"/>
<xsl:include href="../../docbook/xhtml/autoidx.xsl"/>
<xsl:include href="../../docbook/xhtml/lists.xsl"/>
<xsl:include href="../../docbook/xhtml/callout.xsl"/>
<xsl:include href="../../docbook/xhtml/verbatim.xsl"/>
<xsl:include href="../../docbook/xhtml/graphics.xsl"/>
<xsl:include href="../../docbook/xhtml/xref.xsl"/>
<xsl:include href="formal.xsl"/>
<xsl:include href="table.xsl"/>
<xsl:include href="../../docbook/xhtml/htmltbl.xsl"/>
<xsl:include href="../../docbook/xhtml/sections.xsl"/>
<xsl:include href="../../docbook/xhtml/inline.xsl"/>
<xsl:include href="../../docbook/xhtml/footnote.xsl"/>
<xsl:include href="html.xsl"/>
<xsl:include href="../../docbook/xhtml/info.xsl"/>
<xsl:include href="../../docbook/xhtml/keywords.xsl"/>
<xsl:include href="../../docbook/xhtml/division.xsl"/>
<xsl:include href="../../docbook/xhtml/toc.xsl"/>
<xsl:include href="../../docbook/xhtml/index.xsl"/>
<xsl:include href="../../docbook/xhtml/refentry.xsl"/>
<xsl:include href="../../docbook/xhtml/math.xsl"/>
<xsl:include href="../../docbook/xhtml/admon.xsl"/>
<xsl:include href="../../docbook/xhtml/component.xsl"/>
<xsl:include href="../../docbook/xhtml/biblio.xsl"/>
<xsl:include href="../../docbook/xhtml/biblio-iso690.xsl"/>
<xsl:include href="../../docbook/xhtml/glossary.xsl"/>
<xsl:include href="../../docbook/xhtml/block.xsl"/>
<xsl:include href="../../docbook/xhtml/task.xsl"/>
<xsl:include href="../../docbook/xhtml/qandaset.xsl"/>
<xsl:include href="../../docbook/xhtml/synop.xsl"/>
<xsl:include href="../../docbook/xhtml/titlepage.xsl"/>
<xsl:include href="titlepage.templates.xsl"/>
<xsl:include href="../../docbook/xhtml/pi.xsl"/>
<xsl:include href="../../docbook/xhtml/ebnf.xsl"/>
<xsl:include href="../../docbook/xhtml/chunker.xsl"/>
<xsl:include href="../../docbook/xhtml/html-rtf.xsl"/>
<xsl:include href="../../docbook/xhtml/annotations.xsl"/>
<xsl:include href="../../docbook/common/stripns.xsl"/>
...
<!-- The below parameters are not available to modify -->
<xsl:param name="cbp.css.default.source">
.include_data {
  display : none;
}
</xsl:param>
...
<!-- The below parameters are available to modify -->
<xsl:param name="cbp.print.formal.table.title">1</xsl:param> <!-- if param value is 0, print table's format title. otherwise print table title  -->
<xsl:param name="cbp.print.section.title">1</xsl:param> <!-- if param value is 0, print section title. otherwise don't print section title  -->
<xsl:param name="cbp.css.source"></xsl:param>
