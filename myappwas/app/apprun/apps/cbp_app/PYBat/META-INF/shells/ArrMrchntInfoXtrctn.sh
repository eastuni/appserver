...
# ------------------------------------------------------------------------------------------------ #
APPLICATION_LOCATION=$BAT_APP_HOME/PYBat
APPLICATION_NAME=PYBat
BAT_CODE=ArrMrchntInfoXtrctn
...
BXM_HSTDSP "#>>    Process Name  :  ArrMrchntInfoXtrctn.sh"
BXM_HSTDSP "########################################"
