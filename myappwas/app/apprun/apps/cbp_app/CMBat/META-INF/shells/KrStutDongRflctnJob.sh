#!/usr/bin/ksh
# ==================================================================================================
# @file             KrStutDongXtrctnProcessor.sh
#
# @dep-program
#
# @dep-infile
...
# ------------------------------------------------------------------------------------------------ #
APPLICATION_LOCATION=$BAT_APP_HOME/CMBat
APPLICATION_NAME=CMBat
BAT_CODE=KrStutDongXtrctnProcessor
...
BXM_HSTDSP "#>>    Process Name  :  KrStutDongXtrctnProcessor.sh"
BXM_HSTDSP "########################################"
