...
define(
    [
        ...
        , 'text!app/views/page/PWF/402/PWF402-base-tpl.html'
    ...
    function (config
        ...
        var PWF402BaseView = Backbone.View.extend({
            // 태그이름 설정
            tagName: 'section',
            // 클래스이름 설정
            className: 'PWF402-base-page',
            // 탬플릿 설정
            templates: {
                'tpl': tpl
            }
            // 이벤트 설정
            , events: {
                'click .PWF402-reset-btn': 'resetPWF402Base'
                , 'click .PWF402-select-btn': 'selectPWF402Base'
                , 'click .PWF402-save-btn': 'savePWF402Base'
                , 'click .PWF402-delete-btn': 'deletePWF402Base'
                ...
                , 'change .PWF402-bizDscd-wrap': 'changeBizDscd'
                , 'change .PWF402-pdTpCd-wrap': 'changePdTpCd'
                , 'change .PWF402-pdTmpltCd-wrap': 'changePdTmpltCd'
                , 'change .PWF402-pdCd-wrap': 'changePdCd'
                , 'click #srvcCdPop': 'fn_popupSrvcCd'
                , 'click #wflowIdPop': 'fn_popupWflowId'
            ...
            , render: function () {
                ...
                sParam = {};
                selectStyle = {};
                sParam.className = "PWF402-aprvlPtrnDscd-wrap";
                ...
                sParam = {};
                selectStyle = {};
                sParam.className = "PWF402-stsCd-wrap";
                ...
                sParam = {};
                selectStyle = {};
                sParam.className = "PWF402-aprvlRsnCd-wrap";
                ...
                sParam = {};
                selectStyle = {};
                sParam.className = "PWF402-amtTpCd-wrap";
                ...
                sParam = {};
                selectStyle = {};
                sParam.className = "PWF402-crncyCd-wrap";
                ...
                sParam = {};
                selectStyle = {};
                sParam.className = "PWF402-txBrnchDscd-wrap";
                ...
                sParam = {};
                selectStyle = {};
                sParam.className = "PWF402-bizDscd-wrap";
            ...
            // 입출력항목 setting
            /* ======================================================================== */
            , setPWF402BaseData: function (that, responseData, type) {
                var that = this;
                ...
                if (type == "X") {  // 초기화
                    ...
                    that.$el.find('[data-form-param="wflowId"]').val("");       //워크플로우식별자
                    ...
                    that.$el.find('[data-form-param="wflowId"]').val(responseData.AprvlCndMgmtSvcGetAprvlCondDtlOut.wflowId);       //워크플로우식별자
                    that.$el.find('[data-form-param="wflowNm"]').val(responseData.AprvlCndMgmtSvcGetAprvlCondDtlOut.wflowNm);       //워크플로우명
            ...
            /*    Click reset btn                                                       */
            /* ======================================================================== */
            , resetPWF402Base: function (e) {
                initFlag = false;
                this.setPWF402BaseData(this, "", "X");
                    ...
                    success: function (responseData) {
                        ...
                        if (fn_commonChekResult(responseData)) {
                            ...
                            if (responseData.AprvlCndMgmtSvcGetAprvlCondDtlOut.bizDscd == "") {
                                that.setPWF402BaseData(that, responseData, "X");
                            } else {
                                bizDscd = "";
                                pdTpCd = "";
                                pdTmpltCd = "";
                                ...
                                if (bizDscd != null && bizDscd != "") {
                                    ...
                                    sParam.className = "PWF402-pdTpCd-wrap";
                                ...
                                if (pdTpCd != null && pdTpCd != "") {
                                    ...
                                    sParam.className = "PWF402-pdTmpltCd-wrap";
                                    sParam.bizDscd = bizDscd;
                                ...
                                if (pdTmpltCd != null && pdTmpltCd != "") {
                                    ...
                                    sParam.className = "PWF402-pdCd-wrap";
                                    sParam.bizDscd = bizDscd;
                                    sParam.pdTpCd = pdTpCd;
                                ...
                                // 기본부 항목 set
                                that.setPWF402BaseData(that, responseData, "R");
            ...
            /*    Click save btn                                                      */
            /* ======================================================================== */
            , savePWF402Base: function (e) {
                var that = this;
                var sParam = {};
                var instInfo = commonInfo.getInstInfo();
                var instCdBase = instInfo.instCd;
                ...
                sParam.wflowId = that.$el.find('[data-form-param="wflowId"]').val();
            ...
            , loadDatePicker: function () {
                ...
                // 적용시작년월일데이터 피커 렌더
                this.$el.find('.PWF402-aplyStartDt-wrap').html(this.subViews['aplyStartDt'].render());
                ...
                // 적용종료년월일데이터 피커 렌더
                this.$el.find('.PWF402-aplyEndDt-wrap').html(this.subViews['aplyEndDt'].render());
            ...
            , fn_popupWflowId: function () {
                ...
                var popupWflowId = new PopupWflowId(sParam); // 팝업생성
                ...
                popupWflowId.on('popUpSetData', function (param) {
                    ...
                    that.$el.find('[data-form-param="wflowNm"]').val(param.wflowNm); //워크플로우식별자
                });
            }
