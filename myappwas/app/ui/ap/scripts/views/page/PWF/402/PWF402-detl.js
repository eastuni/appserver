define(
    [
        ...
        , 'text!app/views/page/PWF/402/PWF402-detl-tpl.html'
    ...
    function (config
        ...
        var PWF402DetlView = Backbone.View.extend({
            // 태그이름 설정
            tagName: 'section',
            // 클래스이름 설정
            className: 'PWF402-detl-page',
            // 탬플릿 설정
            templates: {
                'tpl': tpl
            }
            // 이벤트 설정
            , events: {
                'click .PWF402-reset-btn': 'resetPWF402Detl'
                , 'click .PWF402-save-btn': 'savePWF402Detl'
                , 'click .PWF402-delete-btn': 'deletePWF402Detl'
                , 'click .PWF402-addRow-btn': 'addPWF402Detl'
                , 'click .PWF402-delRow-btn': 'delPWF402Detl'
                , 'change .PWF402-atrbtVldtnWayCd-wrap': 'chngAtrbtVldtnWayCd'
            ...
            , initialize: function (initData) {
                ...
                sParam = {};
                selectStyle = {};
                sParam.className = "PWF402-atrbtTpCd-wrap";
                ...
                sParam = {};
                selectStyle = {};
                sParam.className = "PWF402-atrbtVldtnWayCd-wrap";
                ...
                /* ------------------------------------------------------------ */
                that.PWF402DtlGrid = new ExtGrid({
                    /* ------------------------------------------------------------ */
                    // 단일탭 그리드 컬럼 정의
                    fields: ['val']
                    , id: 'PWF402SingleGrid'
            ...
            , createGrid: function (target) {
                if (target == "dtl") {
                    this.$el.find(".PWF402-dtl-grid").html(this.PWF402DtlGrid.render({'height': 100}));
                }
            }
            ...
            , resetPWF402Detl: function () {
                ...
                //리셋시 리스트 visible
                this.$el.find('[class="PWF402-dtl-grid"]').show();
                this.$el.find('[class="bx-btn bx-btn-small PWF402-add-btn"]').prop("hidden", false);
                this.$el.find('[class="bx-btn bx-btn-small PWF402-delete-btn"]').prop("hidden", false);
                ...
                that.PWF402DtlGrid.resetData();
            }
            /* ======================================================================== */
            /*   상세그리드 행추가
             /* ======================================================================== */
            , addPWF402Detl: function () {
                this.PWF402DtlGrid.addData(dtlNewData);
            }
            ...
            /*   상세그리드 행추가
             /* ======================================================================== */
            , delPWF402Detl: function () {
                var that = this;
                var gridAllData = that.PWF402DtlGrid.getAllData();
                var selectedRows = that.PWF402DtlGrid.getSelectedItemRow();
                ...
                that.PWF402DtlGrid.store.remove(selectedRows[0]);
            } // end of 행삭제
            ...
            , chngAtrbtVldtnWayCd: function () {
                if (this.$el.find('[data-form-param="atrbtVldtnWayCd"]').val() == "R") {
                    ...
                    //리스트 테이블 hidden
                    this.$el.find('[class="PWF402-dtl-grid"]').hide();
                    this.$el.find('[class="bx-btn bx-btn-small PWF402-add-btn"]').prop("hidden", true);
                    this.$el.find('[class="bx-btn bx-btn-small PWF402-delete-btn"]').prop("hidden", true);


                    this.$el.find('[class="bx-btn bx-btn-small PWF402-addRow-btn"]').prop("hidden", true);
                    this.$el.find('[class="bx-btn bx-btn-small PWF402-delRow-btn"]').prop("hidden", true);
                } else {
                    //범위 테이블 hidden
                    ...
                    this.$el.find('[class="bx-btn bx-btn-small PWF402-addRow-btn"]').prop("hidden", false);
                    this.$el.find('[class="bx-btn bx-btn-small PWF402-delRow-btn"]').prop("hidden", false);
                }
            }
                    ...
                    success: function (responseData) {
                        if (fn_commonChekResult(responseData)) {
                            ...
                            if (tbList != null || tbList.length > 0) {
                                ...
                                that.PWF402DtlGrid.setData(arr);
            ...
            , savePWF402Detl: function () {
                ...
                // 검증Rule
                sParam.listVal = [];
                tbList = that.PWF402DtlGrid.getAllData();
                tbListCnt = that.PWF402DtlGrid.getAllData().length;
            ...
            }           // end of savePWF402Detl: function


            /* ======================================================================== */
            /*   삭제 처리
             /* ======================================================================== */
            , deletePWF402Detl: function () {
                var that = this;
                var sParam = {};
                var header = new Object();
                var headerParam = {};
            ...
            }           // end of deletePWF402Detl: function
