...
<xsl:param name="docbook.css.source">cbpbook.css.xml</xsl:param>
...
<xsl:param name="generate.css.header" select="1"/> <!-- 0, modify : jeh -->
...
<xsl:param name="table.borders.with.css" select="1"/> <!-- 0 -->
<xsl:param name="table.cell.border.color"/>

<xsl:param name="table.cell.border.style">solid</xsl:param>
<xsl:param name="table.cell.border.thickness">1px</xsl:param> <!-- 0.5pt -->
...
<xsl:param name="table.frame.border.thickness">1px</xsl:param> <!-- 0.5pt -->
